...
class KappaLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (
                f'({ident}' + r')(\()',
                bygroups(Agent_Name, Agent_Decor),
                'agent_rule',
            ),
            (
                r'(%agent:)(\s*)(' + ident + r')(\()',
                bygroups(Dec_Keyword, Whitespace, Dec_Ag_Name, Dec_Ag_Decor),
                'agent_declaration',
            ),
            (
                r'(%token:)(\s*)(' + ident + r')',
                bygroups(Dec_Keyword, Whitespace, String),
            ),
            (
                words(
                    ('obs', 'init', 'var', 'plot', 'def'),
                    prefix='%',
                    suffix=':',
                ),
                Misc_Keyword,
            ...
            (r';', Pert_Keyword),
            (
                words(('INF', 'inf', 'alarm'), prefix=r'\b', suffix=r'\b'),
                Pert_Constructs,
            ),
            (
                words(
            ...
            (words(('do', 'repeat'), prefix=r'\b', suffix=r'\b'), Pert_Decor),
            (
                words(
                    (
                        'APPLY',
            ...
            (r'"[^"]+"', Pert_FileName),
            (
                r"([_~][a-zA-Z0-9~+_]+|[a-zA-Z][a-zA-Z0-9_~+-]*)|('[^']*')",
                String,
            ),
            (real, Number),
            (integer, Number),
        ...
        'agent_rule': [
            ...
            (
                ...
                bygroups(
                    Site_Bond_Decor,
                    Site_Bond_State_Site,
                    Site_Bond_Decor,
                    Site_Bond_State_Agent,
                    Site_Bond_Decor,
                ),
            ),
            (
            ...
            (
                ...
                + r')(.)('
                + ident
                + r')(\s*/\s*)(\d+|\.)(\s*\])',  # [site.Agent/.]
                bygroups(
                    Site_Bond_Oper_Decor,
                    Site_Bond_Oper_State_Site,
                    Site_Bond_Oper_Decor,
                    Site_Bond_Oper_State_Agent,
                    Site_Bond_Oper_Decor,
                    Site_Bond_Oper_State,
                    Site_Bond_Oper_Decor,
                ),
        ...
        'agent_declaration': [
            ...
            (
                ...
                bygroups(
                    Dec_Ag_Sign_Site_Ct_d,
                    Dec_Ag_Sign_Site_Ct_s,
                    Dec_Ag_Sign_Site_Ct_d,
                    Dec_Ag_Sign_Site_Ct_s,
                    Dec_Ag_Sign_Site_Ct_d,
                ),
            ...
            (
                r'\[',
                Dec_Ag_Sign_Site_Bd_d,
                'declaration_bond_type',
            ),  # change state
            (
                r'{',
                Dec_Ag_Sign_Site_In_d,
        ...
        'declaration_bond_type': [
            ...
            (
                f'({ident}' + r')(\.)(' + ident + r')',
                bygroups(
                    Dec_Ag_Sign_Site_Bd_s,
                    Dec_Ag_Sign_Site_Bd_d,
                    Dec_Ag_Sign_Site_Bd_a,
                ),
            ),
